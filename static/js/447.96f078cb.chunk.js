...
`,k=()=>{const n=[...r.A].sort((n,e)=>new Date(e.publishDate).getTime()-new Date(n.publishDate).getTime());return(0,l.jsx)(c,{children:(0,l.jsxs)(d,{children:[(0,l.jsx)(s.A,{title:"AWS & Cloud Strategy Blog | North Point Digital",description:"Articles on AWS cost optimisation, landing zones, and cloud strategy from North Point Digital.",canonical:"https://northpointdigital.com/blog"}),(0,l.jsxs)(u,{children:[(0,l.jsx)(g,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},children:"Insights from the Field"}),(0,l.jsx)(p,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.1},children:"Practical articles on AWS cost optimisation, landing zones, and cloud architecture for technology leaders who care about outcomes, not buzzwords."})]}),(0,l.jsx)(h,{children:n.map((n,e)=>(0,l.jsxs)(m,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.2+.1*e},children:[n.thumbnailImage&&(0,l.jsx)(y,{initial:{opacity:0},whileInView:{opacity:1},transition:{duration:.5},viewport:{once:!0},children:(0,l.jsx)(f,{src:n.thumbnailImage,alt:n.title,loading:"lazy"})}),(0,l.jsxs)(b,{children:[(0,l.jsx)(w,{children:n.title}),(0,l.jsxs)(v,{children:[n.publishDate&&(0,l.jsxs)(l.Fragment,{children:[new Date(n.publishDate).toLocaleDateString("en-GB",{year:"numeric",month:"short",day:"numeric"})," \xb7 "]}),n.author]}),(0,l.jsx)(A,{children:n.excerpt}),(0,l.jsx)(x,{to:`/blog/${n.slug}`,children:"Read article"})]})]},n.slug))})]})})}}}]);
//# sourceMappingURL=447.96f078cb.chunk.js.map