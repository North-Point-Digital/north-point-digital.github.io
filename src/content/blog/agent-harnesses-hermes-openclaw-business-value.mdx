...
Two different shapes, same underlying idea: the model is swappable; the harness is where the product lives.
...
2. **Keep a person at the decision point.** Let the agent do the legwork; let a human approve anything that matters.
